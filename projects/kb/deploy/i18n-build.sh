...
my_directory=/cygdrive/v/dev/projects/skb/skb-git/projects/kb/

php_target_directory=${my_directory}src/main/php/targets/tgtphp
htdoc_directory=${my_directory}../../resources/htdocs

autogen_directory=${my_directory}target/base/i18n/php
pot_directory=${my_directory}target/base/i18n/src/pot
po_directory=${my_directory}target/base/i18n/src/po

locale_directory=${my_directory}target/base/i18n/locale
